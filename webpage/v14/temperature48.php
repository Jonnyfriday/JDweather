<?php
	...
	$sql = "SELECT * FROM dht11 order by time desc limit 320";
	$temp = array();
	...
	$temperature_data = array(
		...
		array(date('h:i A', strtotime($time[360])),$temp[360]),
		array(date('h:i A', strtotime($time[432])),$temp[432]),
	);
	...
	//Set titles
	$plot->SetTitle("Temperature Readings - 48 Hours");
