<?php
	...
	$temperature_data = array(
		...
		array(date('h:i A', strtotime($time[72])),$pressure[72]/3386.38816, 2),
		array(date('h:i A', strtotime($time[144])),$pressure[144]/3386.38816, 2),
		array(date('h:i A', strtotime($time[216])),$pressure[216]/3386.38816, 2),
	...
	//Set titles
	$plot->SetTitle("Pressure Readings - 24 Hours");
