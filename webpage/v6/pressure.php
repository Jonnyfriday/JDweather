<?php
	...
	$temperature_data = array(
		array(date('h:i A', strtotime($time[0])),$pressure[0]),
		array(date('h:i A', strtotime($time[1])),$pressure[1]),
		array(date('h:i A', strtotime($time[2])),$pressure[2]),
		array(date('h:i A', strtotime($time[3])),$pressure[3]),
		array(date('h:i A', strtotime($time[4])),$pressure[4]),
	);
	...
	$plot->SetPlotAreaWorld(NULL, 29, NULL, 31);
