<?php
	...
	$temperature_data = array(
		array(date('h:i A', strtotime($time[0])),(round ($pressure [0]/3386.38816, 2))),
		array(date('h:i A', strtotime($time[1])),(round ($pressure [1]/3386.38816, 2))),
		array(date('h:i A', strtotime($time[2])),(round ($pressure [2]/3386.38816, 2))),
		array(date('h:i A', strtotime($time[3])),(round ($pressure [3]/3386.38816, 2))),
		array(date('h:i A', strtotime($time[4])),(round ($pressure [4]/3386.38816, 2))),
	);
	...
	$plot->SetPlotAreaWorld(NULL, 25, NULL, 30);
